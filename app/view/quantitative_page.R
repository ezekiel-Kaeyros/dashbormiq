...
ui <- function(id) {
  ...
  layouts$quantitative_page_layout(affected_person$ui(ns("affected_person")), age_of_affected_person$ui(ns("age_of_affected_person")),
                                   ...
                                   map$ui(ns("map")),location_f$ui(ns("location_f")),sexual_orientation$ui(ns("sexual_orientation")),
                                   gender_identity$ui(ns("gender_identity")),
                                   date_of_occurance$ui(ns("date_of_occurance")), influence_discrimination$ui(ns("influence_discrimination"))) #,location$ui(ns("location"))
}
...
server <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    sexual_orientation$server("sexual_orientation")
    influence_discrimination$server("influence_discrimination")
